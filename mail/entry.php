...
<div style="text-align:center">
  <h2 style="font-size:1.4em; background-color: #dff0d8; color: #3c763d; padding:15px">Запись на тренировку</h2>
  <div style="text-align:left">
    ...
    <h3>Тренировка:&#8194;<?= Html::encode($entry->time->training->description)?></h3>
    <h3>Дата:&#8194;<?= Html::encode($entry->date)?></h3>
    <h3>Время:&#8194;<?= Html::encode($entry->time->begin)?>-<?= Html::encode($entry->time->end)?></h3>
  <hr>
  </div>
