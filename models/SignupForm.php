...
class SignupForm extends Model
{
    ...
    {
        return [
            [['email', 'password', 'firstName','lastName', 'phone', 'confirmPassword'], 'filter', 'filter'=>'trim'],
            ...
            ['phone', 'number', 'message' => 'Только цифры'],
            ['phone', 'string', 'min'=> 11, 'max'=> 11,
                'tooShort' => 'Номер должен состоять из 11 цифр',
                'tooLong' => 'Номер должен состоять из 11 цифр'
            ],
